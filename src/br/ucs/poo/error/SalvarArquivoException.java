...
public class SalvarArquivoException extends Exception{
	...
	public SalvarArquivoException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
		super(MESSAGE + " " + message, cause, enableSuppression, writableStackTrace);
		// TODO Auto-generated constructor stub
	}

	public SalvarArquivoException(String message, Throwable cause) {
	...
	public SalvarArquivoException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
}
